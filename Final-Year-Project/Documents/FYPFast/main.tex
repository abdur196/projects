...
\begin{document}
\newcommand{\supervisor}{Mr. Danyal Farhat}
\newcommand{\university}{National University of Computer and Emerging Sciences, Lahore}
\newcommand{\fyptitle}{AI-Powered Stock Recommender System}
\newcommand{\degree}{BS}
\newcommand{\Studentone}{Bassam Khalid     22L-7456    BS(DS)} 
\newcommand{\Studenttwo}{Abdur Rab Mustafa     22L7538    BS(DS)}
\newcommand{\Studentthree}{Rameez Rehan     22L7502    BS(DS)}
\date{\today}
